package com.iyounix.customview;
...
import com.iyounix.library_cardview.CardAdapter;
import com.iyounix.library_cardview.CardSlidePanel;
import com.iyounix.where2eat.R;

import java.util.ArrayList;
import java.util.List;

public class SearchAroundActivity extends FragmentActivity {
    ...
    private String names[] = {"金粉世家", "荆品豆花", "文雅阁", "金马茶餐厅", "黄焖鸡米饭", "东北饺子馆", "李易峰",
    ...
    class ViewHolder {
        ...
        public void bindData(CardDataItem itemData) {
            Glide.with(SearchAroundActivity.this).load(itemData.imagePath).into(imageView);
